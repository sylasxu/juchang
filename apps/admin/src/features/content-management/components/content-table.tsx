...
import { contentColumns as columns } from './content-columns'
...
export function ContentTable({ data }: DataTableProps) {
  ...
  const table = useReactTable({
    ...
    globalFilterFn: (row, _columnId, filterValue) => {
      ...
      return id.includes(searchValue) || title.includes(searchValue) || content.includes(searchValue)
    },
